...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md border border-slate-200 p-2 flex flex-col md:flex-row gap-2">
            <div className="flex-1 px-4 py-2">
              ...
              <input
                ...
                className="w-full mt-1 text-slate-800 placeholder-slate-400 focus:outline-none text-sm bg-transparent"
              />
            </div>
            ...
            <div className="flex-1 px-4 py-2">
              ...
              <select
                ...
                className="w-full mt-1 text-slate-800 focus:outline-none bg-transparent text-sm cursor-pointer"
              >
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-8 rounded-lg transition-colors duration-200 shadow-sm flex items-center justify-center gap-2 mt-2 md:mt-0"
            >
              <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white rounded-t-3xl shadow-sm border-t border-slate-100">
        <div className="flex justify-between items-end mb-6">
          <div>
            <h2 className="text-2xl font-bold text-slate-900">
              Available Spaces
