...
// ✅ FULLY UPDATED TENANT NAV LINKS
const navLinks = [
  {
    name: "Dashboard",
  ...
  {
    name: "Communications",
    href: "/dashboard/tenant/communications",
  ...
  {
    name: "Profile & Next of Kin",
    href: "/dashboard/tenant/settings",
    icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
  },
];

export default function TenantSidebar({ isOpen, onClose }: SidebarProps) {
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate">Tenant</p>
          </div>
          <button
            onClick={logout}
            title="Logout"
