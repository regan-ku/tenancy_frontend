...
// ✅ FULLY UPDATED NAV LINKS: Added "Staff" for Caretaker/Agent Management
const navLinks = [
  {
    name: "Overview",
  ...
  },
  {
    ...
    icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z", // Single user icon
  },
  {
    name: "Payments",
  ...
  },
  {
    ...
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", // Clipboard/Checklist
  },
  {
    name: "Reports",
  ...
  {
    name: "Staff",
    href: "/dashboard/landlord/staff",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", // Group of users icon
  },
];

export default function LandlordSidebar({ isOpen, onClose }: SidebarProps) {
  const pathname = usePathname();
  const { user, logout } = useAuthStore();

  const displayName = getDisplayName(user);
  const initial = getInitial(user);
  const userEmail = (user as any)?.email || "Manage Account";
